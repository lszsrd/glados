...
mapfile -t valid_test < <(find ./tests/valid_test/ -maxdepth 1 -type f \( -name "*.rz" -o -name "*.scm" \) )
mapfile -t bad_test < <(find ./tests/bad_test/ -maxdepth 1 -type f \( -name "*.rz" -o -name "*.scm" \) )
mapfile -t lib_rizz < <(find ./tests/lib_rizz/ -maxdepth 1 -type f \( -name "*.rz" -o -name "*.scm" \) )
